...
type
  ...
  TZNetworkConnectionTypeH = record Helper for TZNetworkConnectionType
    function GetDesc: String;
  end;
  TZMobileDataType = (None, Unknown, n2G, n3G, n4G);
  TZMobileDataTypeH = record Helper for TZMobileDataType
    function GetDesc: String;
  end;
